...
| `RTC_MEDIA_WORKER_COUNT`                     | available parallelism      | Number of RTC media workers to spawn. Falls back to `1` only when the host cannot report available parallelism.                                                    |
