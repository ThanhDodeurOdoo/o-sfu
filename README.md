...
| `ROOM_MAX_LOCAL_ROUTERS`           | `1`                     | Maximum local routers/workers one room may use. `1` keeps strict single-router behavior; values above one enable bounded deterministic intra-node spillover.      |
