...
impl PendingPublishTransaction {
    ...
    pub(in crate::engine::room) async fn cleanup_reserved_media(
        self,
        operation: RoomUserOperation<'_>,
        failure_message: &str,
    ) -> TransportEffectOutcome {
...
impl Room {
    pub(in crate::engine::room) fn pending_publish_transactions(
        &self,
...
mod tests {
    ...
    use crate::engine::{ConnectionId, UserId, media_transport::TransportMediaId};
