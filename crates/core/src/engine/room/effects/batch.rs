...
#[derive(Debug, Clone, Copy)]
pub(in crate::engine::room) struct MediaCountDelta {
...
#[derive(Debug, Clone)]
pub(in crate::engine::room) struct TransportUserCleanup {
    user_id: UserId,
...
#[derive(Debug, Clone, Copy)]
pub(in crate::engine::room) struct RoomEffectExecution {
