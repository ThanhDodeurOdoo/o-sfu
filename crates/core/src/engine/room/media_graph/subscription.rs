...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::engine::room) struct ConsumerKeyframeRefreshTarget {
...
pub(in crate::engine::room) struct PlannedSubscriptionChange {
...
#[derive(Debug, Clone)]
pub(in crate::engine::room) struct PendingConsumerBootstrapTarget {
...
#[derive(Debug, Clone)]
pub(in crate::engine::room) struct ConsumerBootstrapProducerSnapshot {
...
#[derive(Debug, Clone)]
pub(in crate::engine::room) struct PreparedConsumerBootstrap {
    pub consumer_rtp_parameters: RouterRtpParameters,
}

#[derive(Debug, Clone)]
pub(in crate::engine::room) struct PendingConsumerBootstrap {
...
#[derive(Debug, Clone)]
pub(in crate::engine::room) struct PlannedConsumerBootstrap {
...
pub(in crate::engine::room) enum ConsumerBootstrapOrigin {
    LateJoin,
    Publish,
    Subscribe,
}
