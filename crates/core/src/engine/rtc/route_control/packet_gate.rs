...
pub(in crate::engine::rtc) enum PacketLayerGate {
...
pub(in crate::engine::rtc) struct PacketOperatingPointGate {
...
/// carries it
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub(in crate::engine::rtc) struct PacketLayerMetadata {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::engine::rtc) enum PacketRouteDecision {
...
pub(in crate::engine::rtc) fn aggregate_packet_gates<'a>(
