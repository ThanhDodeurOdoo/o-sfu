...
#[derive(Clone, Copy)]
pub(in crate::engine::rtc::worker::handlers::media) struct ConsumerRouteRegistration<'a> {
...
pub(in crate::engine::rtc::worker::handlers::media) fn ensure_route_source_registered(
...
pub(in crate::engine::rtc::worker::handlers::media) fn ensure_existing_route_source(
    state: &mut PacketLoopState,
    route_owner_session_key: &TransportSessionKey,
    source: &TransportSourceKey,
) -> Result<RouteSourceKind, TransportAdapterError> {
...
pub(in crate::engine::rtc::worker::handlers::media) fn register_consumer_route(
    state: &mut PacketLoopState,
...
/// rewrite target
pub(in crate::engine::rtc::worker::handlers::media) fn consumer_payload_type(
    consumer_rtp_parameters: &RouterRtpParameters,
) -> Option<Pt> {
    consumer_rtp_parameters
        .bindings()
...
pub(in crate::engine::rtc::worker::handlers::media) fn remove_consumer_route(
    state: &mut PacketLoopState,
...
pub(in crate::engine::rtc::worker) fn remove_source_route(
    state: &mut PacketLoopState,
    source_transport_media_id: TransportMediaId,
) {
...
pub(in crate::engine::rtc::worker) fn refresh_source_packet_gate(
    state: &mut PacketLoopState,
    source_transport_media_id: TransportMediaId,
) {
...
/// disappeared
pub(in crate::engine::rtc::worker::handlers::media) fn owned_local_producer_mid(
    state: &PacketLoopState,
...
pub(in crate::engine::rtc) fn worker_set_consumer_packet_gates_for_benchmark(
    state: &mut PacketLoopState,
    source: &TransportSourceKey,
    updates: Vec<ConsumerPacketGateCommand>,
    now: Instant,
...
pub(in crate::engine::rtc::worker::handlers::media) fn packet_gate_rid(
    packet_gate: &PacketLayerGate,
) -> Option<Rid> {
    match packet_gate {
