...
pub(in crate::engine::rtc::worker::handlers::media) fn worker_request_remote_keyframe(
...
pub(in crate::engine::rtc::worker::handlers::media) fn worker_request_consumer_keyframe(
    state: &mut PacketLoopState,
    metrics: &RuntimeMetrics,
