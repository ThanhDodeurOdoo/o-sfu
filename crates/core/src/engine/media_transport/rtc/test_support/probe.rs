...
#[derive(Clone)]
pub(in crate::engine::media_transport::rtc) struct RtcWorkerDebugHandle {
...
pub(in crate::engine::media_transport::rtc) struct RtcWorkerDebugChannels {
...
pub(in crate::engine::media_transport::rtc) trait DebugProbe:
    Send + 'static
{
...
pub(in crate::engine::media_transport::rtc) struct DebugProbeRequest {
...
pub(in crate::engine::media_transport::rtc) fn handle_debug_probe(
    state: &mut PacketLoopState,
    context: &WorkerCommandContext<'_>,
...
#[cfg(test)]
pub(in crate::engine::media_transport::rtc) struct RememberRemoteAddrProbe {
...
#[cfg(test)]
pub(in crate::engine::media_transport::rtc) struct SessionStreamRxSsrcProbe {
    pub session_key: TransportSessionKey,
    pub mid: Mid,
}
...
#[cfg(test)]
pub(in crate::engine::media_transport::rtc) struct SessionStreamTxSsrcProbe {
    pub session_key: TransportSessionKey,
    pub mid: Mid,
}
...
#[cfg(test)]
pub(in crate::engine::media_transport::rtc) struct RecordIncomingMediaProbe {
    pub session_key: TransportSessionKey,
...
#[cfg(any(test, feature = "testing-transport"))]
pub(in crate::engine::media_transport::rtc) struct ObserveAudioActivityProbe {
    pub transport_media_id: TransportMediaId,
    pub voice_activity: Option<bool>,
    pub audio_level_dbov: Option<i8>,
    pub now: Instant,
