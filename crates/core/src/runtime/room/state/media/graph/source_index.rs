...
use super::{
    ProducerRouteTarget, PublishedProducer, PublishedSourceInstall, SourceKey,
    SourceTransportMediaIndexEntry, TransportMediaRemoval, remove_from_index_set,
};
use crate::runtime::{
    ConnectionId, UserId,
    media_transport::TransportMediaId,
    room::state::ids::ProducerRuntimeId,
    source_model::{
...
pub(super) struct SourceIndex {
    descriptors: BTreeMap<PublishedSourceId, PublishedSourceDescriptor>,
...
impl SourceIndex {
    ...
    pub(super) fn source_ids_for_owner_snapshot(&self, user_id: &UserId) -> Vec<PublishedSourceId> {
        self.source_ids_for_owner(user_id).collect()
    }
    ...
    pub(super) fn is_empty(&self) -> bool {
        self.descriptors.is_empty()
            ...
            && self.source_transport_media_index.is_empty()
    }

    #[cfg(test)]
    pub(super) fn owner_state_is_empty(&self, user_id: &UserId) -> bool {
