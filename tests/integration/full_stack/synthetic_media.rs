...
fn fake_media_source_uses_manual_clock_deterministically() {
    ...
    assert_eq!(first.emitted_at, s::Duration::from_millis(20));
    assert_eq!(second.emitted_at, s::Duration::from_millis(40));
    ...
    assert_eq!(
        ...
        Some(s::SYNTHETIC_OPUS_ONE_FRAME_TOC)
    );
