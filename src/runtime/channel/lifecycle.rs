...
pub(crate) struct ChannelSessionPermissions {
    transcription: bool,
    audio_recording: bool,
    video_recording: bool,
}

impl ChannelSessionPermissions {
    #[must_use]
...
impl From<SessionPermissions> for ChannelSessionPermissions {
    fn from(value: SessionPermissions) -> Self {
        Self {
