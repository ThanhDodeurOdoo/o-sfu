...
impl SessionPresence {
    pub(in crate::runtime::channel) fn apply_update(&mut self, info: &SessionInfo) {
    ...
    #[must_use]
    pub(in crate::runtime::channel) const fn talking(&self) -> Option<bool> {
        self.talking
    }

    #[must_use]
    pub(in crate::runtime::channel) const fn self_muted(&self) -> Option<bool> {
        self.self_muted
    }

    #[must_use]
    pub(in crate::runtime::channel) const fn deaf(&self) -> Option<bool> {
        self.deaf
    }

    #[must_use]
    pub(in crate::runtime::channel) const fn raising_hand(&self) -> Option<bool> {
        self.raising_hand
    }
}
