...
pub(crate) struct RoomManagerConfig {
...
impl RoomManagerConfig {
    #[must_use]
    pub(crate) fn new(media_worker_count: usize, runtime_policy: RoomRuntimePolicy) -> Self {
        Self {
            media_worker_count,
            runtime_policy,
        }
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct RuntimeRoomStatsSnapshot {
    pub(crate) create_date: String,
    pub(crate) uuid: String,
    pub(crate) remote_address: String,
    pub(crate) users_stats: RoomUserStatsSnapshot,
...
pub(crate) struct JoinUserRequest {
    pub(crate) user_id: UserId,
    pub(crate) label: Option<String>,
    pub(crate) permissions: UserPermissions,
    pub(crate) sender: mpsc::UnboundedSender<UserOutbound>,
}
...
#[derive(Debug, Clone)]
pub(crate) struct RuntimeRoomDirectorySnapshot {
    room: Arc<Room>,
    create_date: String,
...
impl RoomManager {
    ...
    pub(crate) async fn directory_snapshots(&self) -> Vec<RuntimeRoomDirectorySnapshot> {
